...
export const forgotPasswordTemplate = (email, resetLink) => {
  return `
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html dir="ltr" lang="en" xmlns="http://www.w3.org/1999/xhtml">
  <head>
  ...
  >
    <!-- preheader (hidden) -->
    <div style="display:none; overflow:hidden; line-height:1px; opacity:0; max-height:0; max-width:0;">
      Reset your password with the secure link inside — link expires in 10 minutes.
      ‌​‍‎‏﻿‌​‍‎‏﻿‌​‍‎‏﻿‌​‍‎‏﻿‌​‍‎‏﻿‌​‍‎‏﻿
    </div>
          ...
          >
            <tr>
              <td class="responsive-container" style="padding: 48px 40px 52px 40px; background-color: #ffffff;">
                ...
                <!-- expiry info + helper -->
                <p style="margin: 0 0 24px 0; font-size: 14px; color: #6b7280; line-height: 1.4;">
                  ⏳ This link expires in <strong style="color:#111111;">10 minutes</strong> and can only be used once.
                </p>
